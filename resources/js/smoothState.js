...
const defaultOptions = {
        ...
        /** Where the links should be registered from */
        root: null,
...
const onPopState = function ( e ) {
    if(e.state !== null) {
        ...
        if(typeof page !== 'undefined' && page.href !== url && !utility.isHash(url, page.href)) {
            page.load(url, false);
        }
    }
};
...
const Smoothstate = function ( element, options ) {
    var
