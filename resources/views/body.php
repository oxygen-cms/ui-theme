...
<?php if(!Auth::check() || Auth::user()->getPreferences()->get('pageLoad.smoothState.enabled', true) === true): ?>
    <script src="/vendor/oxygen/ui-theme/vendor/smoothState<?php if(!config('app.debug')) { echo '.min'; } ?>.js"></script>
<?php endif; ?>
<script src="/vendor/oxygen/ui-theme/vendor/tagging.min.js"></script>
